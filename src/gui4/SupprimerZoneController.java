 ...
 * @author abdel
 */
public class SupprimerZoneController implements Initializable {

    @FXML
    private TextField idZone;
    @FXML
    private Button Supprimerzone;
    @FXML
    ...
    @FXML
    private void SupprimerZone(ActionEvent event) {
        Servicezone sz = new Servicezone();
        sz.supprimer(new Zonedacces( (int) Float.parseFloat(idZone.getText())));
